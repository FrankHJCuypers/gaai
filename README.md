...
[![compose](https://img.shields.io/badge/Jetpack%20Compose-4285F4?style=for-the-badge&logo=Jetpack%20Compose&logoColor=white)](https://developer.android.com/compose)
[![gradle](https://img.shields.io/badge/gradle-02303A?style=for-the-badge&logo=gradle&logoColor=white)](https://gradle.org/)
[![Junit 5](https://img.shields.io/badge/Junit5-25A162?style=for-the-badge&logo=junit5&logoColor=white)](https://junit.org/)
...
+ The bottom row shows
    + At the left the MAC.
    + At the right the Service Data used to find the BLE device based on its advertisement packet.

Possible bonding states:

| Value      | Icon                                                                                     | Description                                                     |
|------------|------------------------------------------------------------------------------------------|-----------------------------------------------------------------|
| Not Bonded | ![Not Bonded](docs/images/bluetooth_disabled_24dp_1F1F1F_FILL0_wght400_GRAD0_opsz24.svg) | Device is not bonded and bonding process has not been initiated |
| Bonding    | ![Bonding](docs/images/bluetooth_searching_24dp_1F1F1F_FILL0_wght400_GRAD0_opsz24.svg)   | Device is not bonded, but bonding process has been initiated    |
| Bonded     | ![Bonded](docs/images/bluetooth_connected_24dp_1F1F1F_FILL0_wght400_GRAD0_opsz24.svg)    | Device is bonded                                                |
...
The details for each card are as explained in [Add a Nexxtender device](#add-a-nexxtender-device).

If the Availability status stays *Not Available*,
it might be that another BLE client is still connected to the device or that the device is out of range.
...
The first card at the top has the same contents as described in [Add a Nexxtender device](#add-a-nexxtender-device)
except for the second row that no longer contains the Availability state but:
...
| Terminal_Local_Host | ![Terminal_Local_Host](docs/images/bluetooth_disabled_24dp_1F1F1F_FILL0_wght400_GRAD0_opsz24.svg) | The local device initiated disconnection                                                                                  | 
| Terminal_Peer_User  | ![Terminal_Peer_User](docs/images/bluetooth_disabled_24dp_1F1F1F_FILL0_wght400_GRAD0_opsz24.svg)  | The peer user initiated disconnection                                                                                     | 
| Link_Loss           | ![Link_Loss](docs/images/bluetooth_disabled_24dp_1F1F1F_FILL0_wght400_GRAD0_opsz24.svg)           | Disconnection was not from the peer user performing a graceful disconnect                                                 |
| Not_Supported       | ![Not_Supported](docs/images/bluetooth_disabled_24dp_1F1F1F_FILL0_wght400_GRAD0_opsz24.svg)       | The device does not have the requierd services                                                                            |
| Cancelled           | ![Cancelled](docs/images/bluetooth_disabled_24dp_1F1F1F_FILL0_wght400_GRAD0_opsz24.svg)           | Connection attempt was cancelled                                                                                          |
| Timeout             | ![Timeout](docs/images/bluetooth_disabled_24dp_1F1F1F_FILL0_wght400_GRAD0_opsz24.svg)             | The connection timed out. The device might have reboot, is out of range, turned off or doesn't respond for another reason |
| Unknown             | ![Unknown](docs/images/bluetooth_disabled_24dp_1F1F1F_FILL0_wght400_GRAD0_opsz24.svg)             | Unknown error                                                                                                             |
...
| Motorola G20         | (11)                  | Home 2.52.2                 | V1.1.0?          |
