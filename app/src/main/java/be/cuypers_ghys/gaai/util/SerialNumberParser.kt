...
object SerialNumberParser {
     ...
     *  NNNN' is the number that corresponds with the ASCII string NNNN.
     */
    fun calcHexSerialNumber(serialNumber: SerialNumber): UInt  {
        val hexSerialNumber = (serialNumber.year.toInt() shl 24) or (serialNumber.month.toInt() shl 16) or serialNumber.number.toInt()
