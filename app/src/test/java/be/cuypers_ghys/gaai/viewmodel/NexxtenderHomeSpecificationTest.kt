...
/**
 * JUnit tests for the [NexxtenderHomeSpecification] class.
    ...
    fun usedCombinationsProvider(): Stream<Arguments> {
      return Stream.of(
        Arguments.of(
          ...
          NexxtenderHomeSpecification.UUID_BLE_GENERIC_ACCESS_SERVICE
        ),
        Arguments.of(
          "00002a00-0000-1000-8000-00805f9b34fb",
          NexxtenderHomeSpecification.UUID_BLE_DEVICE_NAME_CHARACTERISTIC
        ),
        Arguments.of(
          "00002a01-0000-1000-8000-00805f9b34fb",
          NexxtenderHomeSpecification.UUID_BLE_APPEARANCE_CHARACTERISTIC
        ),
        Arguments.of(
          "00002a04-0000-1000-8000-00805f9b34fb",
          NexxtenderHomeSpecification.UUID_BLE_PERIPHERAL_PREFERRED_CONNECTION_CHARACTERISTIC
        ),
        Arguments.of(
          "00001801-0000-1000-8000-00805f9b34fb",
          NexxtenderHomeSpecification.UUID_BLE_GENERIC_ATTRIBUTE_SERVICE
        ),
        Arguments.of(
          "00002a05-0000-1000-8000-00805f9b34fb",
          NexxtenderHomeSpecification.UUID_BLE_SERVICE_CHANGED_CHARACTERISTIC
        ),
        Arguments.of(
          "0000180a-0000-1000-8000-00805f9b34fb",
          NexxtenderHomeSpecification.UUID_BLE_DEVICE_INFORMATION_SERVICE
        ),
        Arguments.of(
