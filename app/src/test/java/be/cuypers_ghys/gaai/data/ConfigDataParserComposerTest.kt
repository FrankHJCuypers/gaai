...
class ConfigDataParserComposerTest {
    ...
    fun parse_VerifyResultsFromKnownTestVectors(configData : ByteArray,
                                                expectedMaxGrid: Int,
    ...
    fun compose_VerifyResultsFromKnownTestVectors(expectedConfigData : ByteArray,
        ...
        val configData = ConfigData(maxGrid.toUByte(),
    ...
    companion object {
        ...
        fun usedCombinationsProvider(): Stream<Arguments> {
            return Stream.of(
                ...
                Arguments.of("112201440066778899AABBCCDD474A".hexToByteArray(), 0x11, 0x22, 0x00, Mode.MAX_PRIVATE, 0x44, NetWorkType.MONO_TRIN, 0x7766, 0x9988, 0xBBAA, 0xDDCC, 0x00, ConfigVersion.CONFIG_1_1),
                Arguments.of("112204440066778899AABBCCDD5686".hexToByteArray(), 0x11, 0x22, 0x00, Mode.ECO_OPEN, 0x44, NetWorkType.MONO_TRIN, 0x7766, 0x9988, 0xBBAA, 0xDDCC, 0x00, ConfigVersion.CONFIG_1_1),
                Arguments.of("112269446966778899AABBCCDD5179".hexToByteArray(), 0x11, 0x22, 0x00, Mode.UNKNOWN, 0x44, NetWorkType.UNKNOWN, 0x7766, 0x9988, 0xBBAA, 0xDDCC, 0x00, ConfigVersion.CONFIG_1_1),
                ...
                Arguments.of("11044466778899AABBCCDD533B".hexToByteArray(), 0x11, 0x00, 0x00, Mode.ECO_OPEN, 0x44, NetWorkType.UNKNOWN, 0x7766, 0x9988, 0xBBAA, 0xDDCC, 0x00, ConfigVersion.CONFIG_1_0),
                Arguments.of("11014466778899AABBCCDD432B".hexToByteArray(), 0x11, 0x00, 0x00, Mode.MAX_PRIVATE, 0x44, NetWorkType.UNKNOWN, 0x7766, 0x9988, 0xBBAA, 0xDDCC, 0x00, ConfigVersion.CONFIG_1_0),
                Arguments.of("11694466778899AABBCCDDC17F".hexToByteArray(), 0x11, 0x00, 0x00, Mode.UNKNOWN, 0x44, NetWorkType.UNKNOWN, 0x7766, 0x9988, 0xBBAA, 0xDDCC, 0x00, ConfigVersion.CONFIG_1_0),
                ...
                Arguments.of("A200A20101020101AB01010418F00518F00618F007186909000C1977660D1999880E19BBAA0F19DDCC1318967A63".hexToByteArray(), 0xF0, 0xF0, 0xF0, Mode.MAX_PRIVATE, 0x69, NetWorkType.MONO_TRIN, 0x7766, 0x9988, 0xBBAA, 0xDDCC, 0x96, ConfigVersion.CONFIG_CBOR),
                Arguments.of("A200A20101020101AB01040418F00518F00618F007186909000C1977660D1999880E19BBAA0F19DDCC1318967AFA".hexToByteArray(), 0xF0, 0xF0, 0xF0, Mode.ECO_OPEN, 0x69, NetWorkType.MONO_TRIN, 0x7766, 0x9988, 0xBBAA, 0xDDCC, 0x96, ConfigVersion.CONFIG_CBOR),
