...
class ChargingGridDataParserTest {
    ...
    fun parse_VerifyResultsFromKnownTestVectors(chargingGridData : ByteArray,
    ...
    companion object {
        ...
        fun usedCombinationsProvider(): Stream<Arguments> {
            return Stream.of(
                Arguments.of("1234567890ABCDEF1234567890ABEEDB".hexToByteArray(), 0x78563412, 0xAB90, 0xEFCD, 0x3412, 0x7856, 0xAB90),
                Arguments.of("11223344556677889900AABBCCDDC1D3".hexToByteArray(), 0x44332211, 0x6655, 0x8877, 0x0099, 0xBBAA, 0xDDCC),
                Arguments.of("FB0E2D66000000000000370013038814".hexToByteArray(), 0x662D0EFB, 0x0000, 0x0000, 0x0000, 0x0037, 0x0313),
            )
        }
    }
}