...
/**
 * JUnit tests for [ChargingAdvancedDataParser].
...
class ChargingAdvancedDataParserTest {
  ...
  fun parse_VerifyResultsFromKnownTestVectors(
    chargingAdvancedData: ByteArray,
    ...
    fun usedCombinationsProvider(): Stream<Arguments> {
      return Stream.of(
        Arguments.of(
          ...
          0x3412EFCD,
          0xAB907856,
          AuthorizationStatus(0xCD.toByte()),
          0xEF
        ),
        Arguments.of(
          ...
          0x00998877,
          0xDDCCBBAA,
          AuthorizationStatus(0xEE.toByte()),
          0xFF
        ),
        Arguments.of(
          "660F2D660600FEFFFFFF0000000001009764".hexToByteArray(),
          0x662D0F66,
          0x0006,
          0xFFFFFFFE,
          0x00000000,
          AuthorizationStatus(0x01.toByte()),
          0x00
        ),
      )
    }
